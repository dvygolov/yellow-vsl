...
const mainPlayer = window.YellowVSL.create("#main-player", {
  ...
  hooks: [{ id: "mini-hook", start: 2, end: 5.5, text: "Mini-hook работает: оффер появится на шестой секунде", placement: "above" }],
  ctas: [{ id: "demo-offer", start: 6, text: "Перейти к открытому предложению", reveal: "#offer", persist: true }]
});
